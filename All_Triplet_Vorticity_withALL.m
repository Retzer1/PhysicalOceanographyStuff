function [VORTS, numTriangles, SIZES, DISTS] = All_Triplet_Vorticity_withALL(struc, errorQ, centerArray) %output is a 3d matrix, each page corresponds to a timestep, holds a column vector containing divergence estimates for all triangles at that timestep. 
newStruc = struc;
