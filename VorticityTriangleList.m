function DATA = VorticityTriangleList(struc, errorQ) %output is an n x 3 matrix, where cols 1 and 2 correspond to COM lat and COM lon of a valid triangle, and col 3 corresponds to that triangle's divergence estimate.  
