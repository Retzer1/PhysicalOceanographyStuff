function newStruc = manualIndexSelectorSpeed(struc, whichOnes) %Loops over some drifters in a structure, letting user crop/trim the data for each drifter, one at a time
