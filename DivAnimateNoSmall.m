function [numTriangles] = DivAnimateNoSmall(struc, errorQ, fps, filename) %Animates the triplet divergence estimates, excluding small triangles
...
%V in plottricols will come from Colors
