function [SHEARS, numTriangles] = All_Triplet_Shear(struc, errorQ) %output is a 3d matrix, each page corresponds to a timestep, holds a column vector containing shear deformation estimates for all triangles at that timestep. 
newStruc = struc;
