function [output, numTriangles] = avgVorticity(struc, errorQ, meanFlag) %output is a vector of length as many time steps as we have. 
...
for i = 1:lenDate %Loop over datenums
    ...
    latLon = latLonMat(:, [1 2]); %COL 1 is lat, COL 2 is lon
